        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              This class entry doesn't have detailed mechanical data available,
              but you can find information in the description above.
            </p>
          </div>
          ...
          <CompendiumFeatureDisplay
            entry={{
              ...
              specific_data: { traits: [], autolevels: {}, features: [] },
            }}
          />
        </div>
      );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  <strong>Ritual:</strong> {data.ritual ? "Yes" : "No"}
                </div>
                <div>
                  <strong>Casting Time:</strong> {data.time}
                </div>
                <div>
                  <strong>Range:</strong> {data.range}
                </div>
                <div>
                  <strong>Components:</strong> {data.components}
                </div>
                <div>
                  <strong>Duration:</strong> {data.duration}
                </div>
                <div>
                  <strong>Classes:</strong> {data.classes}
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                {data.weight && (
                  <div>
                    <strong>Weight:</strong> {data.weight} lbs
                  </div>
                )}
                {data.value && (
                  <div>
                    <strong>Value:</strong> {data.value} gp
                  </div>
                )}
                {data.ac && (
                  <div>
                ...
                {data.dmg1 && (
                  <div>
                    <strong>Damage:</strong> {data.dmg1} {data.dmgType}
                  </div>
                )}
                {data.range && (
                  <div>
                ...
                <div>
                  <strong>Magic:</strong> {data.magic ? "Yes" : "No"}
                </div>
              </div>
            </div>
            {data.property && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    <strong>STR:</strong> {data.str}
                  </div>
                  <div>
                    <strong>DEX:</strong> {data.dex}
                  </div>
                  <div>
                    <strong>CON:</strong> {data.con}
                  </div>
                  <div>
                    <strong>INT:</strong> {data.int}
                  </div>
                  <div>
                    <strong>WIS:</strong> {data.wis}
                  </div>
                  <div>
                    <strong>CHA:</strong> {data.cha}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 text-sm">
                ...
                {data.ability && (
                  <div>
                    <strong>Ability Score Increase:</strong> {data.ability}
                  </div>
                )}
                {data.proficiency && (
                  <div>
                    <strong>Proficiencies:</strong> {data.proficiency}
                  </div>
                )}
              </div>
              {data.traits && data.traits.length > 0 && (
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 text-sm">
                  {data.hd && (
                    <div>
                      <strong>Hit Die:</strong> d{data.hd}
                    </div>
                  )}
                  {data.proficiency && (
                    <div>
                  ...
                  {data.numSkills && (
                    <div>
                      <strong>Skill Choices:</strong> {data.numSkills}
                    </div>
                  )}
                  {data.armor && (
                    <div>
                  ...
                  {data.weapons && (
                    <div>
                      <strong>Weapons:</strong> {data.weapons}
                    </div>
                  )}
                  {data.tools && (
                    <div>
                  ...
                  {data.wealth && (
                    <div>
                      <strong>Starting Wealth:</strong> {data.wealth}
                    </div>
                  )}
                  {data.spellAbility && (
                    <div>
                      <strong>Spellcasting Ability:</strong> {data.spellAbility}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 text-sm">
                  {data.parent_class_id && (
                    <div>
                      <strong>Parent Class:</strong> Available in database
                    </div>
                  )}
                </div>
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 text-sm">
                {data.proficiency && (
                  <div>
                    <strong>Skill Proficiencies:</strong> {data.proficiency}
                  </div>
                )}
                {data.languages && (
                  <div>
        ...
        <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-2">
                      <Badge
                        variant={entry.is_system ? "secondary" : "default"}
                      >
          ...
          {entry.specific_data && (
            <Card>
              ...
              <CardContent>{renderSpecificData()}</CardContent>
            </Card>
          )}
        </div>
      </div>
